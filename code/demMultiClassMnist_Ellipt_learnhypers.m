...
tic;
[model samples accRates] = gpsampEllipt_learnhypers(model, mcmcoptions);
elapsedTime = toc;
...
summaryEllipt.accRates = accRates;
summaryEllipt.kerndelta = model.kerndelta;
summaryEllipt.eff_F = eff_F;
summaryEllipt.eff_kern = eff_kern;
summaryEllipt.LogL = samples.LogL;
 
save(['../results/' dataName '_Ellipt_learnhypers.mat'], 'summaryEllipt', 'model', 'samples');
