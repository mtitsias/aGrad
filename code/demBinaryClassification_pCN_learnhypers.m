...
%     
   ...
   summarypCN.kerndelta = model.kerndelta;
   for j=1:model.GP{1}.nParams
      summarypCN.eff_kern(j) = mcmc_ess(samples.kernLogtheta{1}(:,j));
   end
   
   save(['../results/' dataName{1} '_pCN_learnhypers.mat'], 'summarypCN', 'model', 'samples');
%    
end