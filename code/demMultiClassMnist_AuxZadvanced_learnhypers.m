...
summaryAuxZadvanced.eff_F = eff_F;
summaryAuxZadvanced.eff_kern = eff_kern;
summaryAuxZadvanced.LogL = samples.LogL;
 
save(['../results/' dataName '_AuxZadvanced_learnhypers.mat'], 'summaryAuxZadvanced', 'model', 'samples');
