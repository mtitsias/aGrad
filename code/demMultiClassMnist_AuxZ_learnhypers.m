...
summaryAuxZ.eff_F = eff_F;
summaryAuxZ.eff_kern = eff_kern;
summaryAuxZ.LogL = samples.LogL;
 
save(['../results/' dataName '_AuxZ_learnhypers.mat'], 'summaryAuxZ', 'model', 'samples');
