function demLogGaussianCoxGirolamiEllipt(rep)

addpath toolbox/; 
dataName = 'logGaussianCoxGirolami_Ellipt';
storeRes = 1;
...
if storeRes == 1
    ...
    if rep == 1
       save(['../results/' dataName '_repeat' num2str(rep) '.mat'], 'summaryEllipt', 'model', 'samples');
    else
